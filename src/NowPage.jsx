...
export default function NowPage({ setView, onRepeatTracks = [] }) {
    ...
    return (
        ...
        <div className="now-playing-card" style={{ width: '100%', maxWidth: '600px', margin: '0 auto' }}>
            <p style={{ fontSize: '0.8rem', fontFamily: 'monospace', color: 'var(--text-muted)', marginBottom: '-2rem', paddingLeft: '4px' }}>
            Songs on repeat
            </p>
            
            <ScrollStack 
            useWindowScroll={true}
            itemDistance={400} /* Must be larger than the 352px iframe height */
            itemStackDistance={45} /* The 45px sliver that stays visible */
            baseScale={0.9} 
            itemScale={0.03} /* Slightly scales down cards further back */
            stackPosition="15%" /* Pins near the top of the viewport */
            ...
            {onRepeatTracks.map((track) => {
                ...
                >
                    <div style={{
                        height: '352px', /* Forces the exact height immediately */
                        minHeight: '352px',
                        width: '100%',
                        borderRadius: '24px',
        ...
        <div style={{ width: '100%', maxWidth: '600px', margin: '0 auto' }}>
            <p style={{ fontSize: '0.8rem', fontFamily: 'monospace', color: 'var(--text-muted)', marginTop: '2rem', marginBottom: '1rem', paddingLeft: '4px' }}>
            Journeys
            </p>
        ...
        <div style={{ 
            ...
            style={{ 
                display: 'flex', 
                gap: '1.5rem', 
                paddingRight: '1.5rem', // Required so the gap spacing is perfectly calculated during the loop snap
                width: 'max-content' 
            }}
            >
